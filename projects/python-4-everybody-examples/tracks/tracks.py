...
# function to lookup key's in a dictionary
def lookup(d, key):
    found = False
    for child in d:
...
# find all dict childs of the second nested dict
all = stuff.findall('dict/dict/dict')
# count the number of dict childs
print('Dict count:', len(all))

# loop over all items
for entry in all:
    # if result doesnt exists continue the loop
